...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  #
  # Why?
  # The repetition characters match as many times as possible while still allowing any following parts of the regular expression to match. We say that the repetition is "greedy."
  ...
  #regular expressions are applied to the input starting at the first character and proceeding to the last. As soon as a match is found it returns
  ...
  # character class matches single characters where alternation matches multiple characters
  # ------------------------------------------------------------------
